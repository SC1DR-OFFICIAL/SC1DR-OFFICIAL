...
A Telegram-based real estate platform that links the public listings experience with the agency’s internal operations. Clients get filter-based search, subscriptions, and up-to-date offers focused on central Tashkent. Staff work in a CRM for inventory and day-to-day workflows, while an OLX monitoring pipeline surfaces new marketplace listings by configurable categories and tags. Publishing is end-to-end: listings go to Telegram channels and OLX without manual copy-paste.
